...
var
  ...
  begin
    ...
    begin
      ...
      shufflecount1 := 1 + random(52);
      shufflecount2 := 1 + random(52);
      container1 := theDeck[shufflecount1];
      container2 := theDeck[shufflecount2];
      theDeck[shufflecount1] := container2;
      theDeck[shufflecount2] := container1;
    end;
  ...
  begin
    ...
    begin
      for cardInSuitIndex := 1 to Length(SuitValues) do
        ...
        deck[cardInSuitIndex * suitIndex] := SuitValues[cardInSuitIndex];
